...
| ไฟล์ | ปริมาณ |
|---|---|
| `lessons.ts` | 16 บท · 322 คำศัพท์ · 134 วลี · 117 บรรทัดสนทนา · 99 โน้ต |
| `sentences.ts` + `sentencesExtra.ts` + `sentences16.ts` | 473 ประโยคเรียงคำ (421 + 27 คำ HSK 1 + 25 บทที่ 16) · 11 หมวด (`sentenceCats`) — เขียนมือทั้งหมด ไม่ได้ derive จากบท · รวมกันที่ `allSentences` ใน `lib/pools.ts` |
...
(บทที่ 16 ย้าย 现在 · 时候 · 电影 · 少 · 东西 ออกมา → `hsk1Extra` เหลือ 40 คำ)
