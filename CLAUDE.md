...
| ไฟล์ | ปริมาณ |
|---|---|
| `lessons.ts` | 18 บท · 374 คำศัพท์ · 182 วลี · 146 บรรทัดสนทนา · 125 โน้ต (บท 18 บทสนทนายังมีแค่หน้า 28 — รอรูปหน้า 29) |
| `sentences.ts` + `sentencesExtra.ts` + `sentences16.ts` + `sentences17.ts` + `sentences18.ts` | 537 ประโยคเรียงคำ (421 + 27 คำ HSK 1 + 29 บทที่ 16 + 30 บทที่ 17 + 30 บทที่ 18) · 11 หมวด (`sentenceCats`) — เขียนมือทั้งหมด ไม่ได้ derive จากบท · รวมกันที่ `allSentences` ใน `lib/pools.ts` |
